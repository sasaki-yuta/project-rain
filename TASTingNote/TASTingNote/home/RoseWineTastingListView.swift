...
struct RoseWineTastingListView: View {
    ...
    private var wines: [roseWine]

    @Environment(\.modelContext)
    private var context
    
    // 検索用
    private var filteredWines: [roseWine] {
