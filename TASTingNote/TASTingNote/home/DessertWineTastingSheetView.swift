//
//  DessertWineTastingSheetView.swift
//  TastingApp
//
...
extension DessertWineTastingSheetView {
...
final class DessertWineLocationManager:
    NSObject,
    ObservableObject,
