//
//  SparklingWineTastingSheetView.swift
//  TastingApp
//
...
extension SparklingWineTastingSheetView {
...
final class SparklingWineLocationManager:
    NSObject,
    ObservableObject,
