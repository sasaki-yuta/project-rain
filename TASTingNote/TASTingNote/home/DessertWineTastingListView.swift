//
//  DessertWineTastingListView.swift
//  TastingApp
//
...
struct DessertWineTastingListView: View {
    ...
    private var wines: [dessertWine]

    @Environment(\.modelContext)
    private var context
    
    // 検索用
    private var filteredWines: [dessertWine] {
...
struct AddDessertWineView: View {
